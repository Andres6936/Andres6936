export default function Projects() {
    return (
        <>
            <section className="flex flex-col md:flex-row gap-6 items-center justify-center md:w-3/4 mx-auto mt-24">
                <div className="flex w-5/6 md:flex-[3] bg-white h-96 rounded-2xl px-8 py-12">
                    <h1 className="text-3xl">I've been helping</h1>
                </div>

                <div className="flex w-5/6 md:flex-[2] bg-black h-96 rounded-2xl px-4 py-12">
            ...
            <section
                className="flex flex-col md:flex-row gap-6 items-center justify-center w-5/6 md:w-3/4 mx-auto mt-6">
                <div
                    className="flex w-full md:w-auto flex-[3] items-center justify-center bg-black text-white p-4 rounded-full">
                    <p>See All - Template</p>
                </div>

                <div
                    className="flex w-full md:w-auto flex-[2] items-center justify-center bg-white p-4 rounded-full border-zinc-300 border">
                    <p>Contact Me</p>
                </div>
            </section>
        </>
